<template>
    <div class="nav-main">
        <van-nav-bar @click-left="go_back" class="xz-nva-bar" title="更换手机" fixed left-arrow/>
        <form class="xz-lr">
            ...
            <div class="xz-lr-box xz-lr-btn">
                <button type="button" class="xz-btn btn-e43 xz-radius" @click="checkCode">确认更换手机</button>
            </div>
        </form>
...
export default {
    ...
    data() {
        return {
            ...
            reserveParams: {
                method: "api.module.member.info.change_mobile",
                mobile: "",
                code: ""
            },
            checkMessage: 0
    ...
    methods: {
        async loadData() {
            let _this = this;
            let _mobile = _this.$route.params.id;
